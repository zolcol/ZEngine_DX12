...
public:
	...
	static void Property(const char* PropName, const char** options, int optionCount, int& selectedIndex);
	static void ColorProperty(const char* PropName, DirectX::XMFLOAT3& value);
private:
